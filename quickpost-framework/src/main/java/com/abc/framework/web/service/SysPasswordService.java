...
import com.abc.common.exception.user.UserPasswordNotMatchException;
import com.abc.common.exception.user.UserPasswordRetryLimitExceedException;
...
public class SysPasswordService
{
    ...
    public void checkMaxRetryCount(String username) {
        Integer retryCount = redisCache.getCacheObject(getCacheKey(username));
    ...
    public void addMaxRetryCount(String username) {
        Integer retryCount = redisCache.getCacheObject(getCacheKey(username));
        retryCount = retryCount + 1;
        redisCache.setCacheObject(getCacheKey(username), retryCount, lockTime, TimeUnit.MINUTES);
    }
