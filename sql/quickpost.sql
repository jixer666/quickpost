...
-- ----------------------------
-- Table structure for tb_anonymous_user
-- ----------------------------
DROP TABLE IF EXISTS `tb_anonymous_user`;
CREATE TABLE `tb_anonymous_user`  (
  `any_user_id` bigint NOT NULL COMMENT '匿名用户ID',
  `ip` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT 'IP地址',
  `create_time` datetime NULL DEFAULT NULL COMMENT '创建时间',
  `status` tinyint NULL DEFAULT NULL COMMENT '状态',
  PRIMARY KEY (`any_user_id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '匿名用户表' ROW_FORMAT = Dynamic;
...
-- ----------------------------
-- Table structure for tb_pack
-- ----------------------------
DROP TABLE IF EXISTS `tb_pack`;
CREATE TABLE `tb_pack`  (
  `pack_id` bigint NOT NULL COMMENT '包裹ID',
  `file_ids` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT '文件ID列表',
  `code` varchar(6) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '取件码',
  `valid_time_type` tinyint NULL DEFAULT NULL COMMENT '有效期类型',
  `user_id` bigint NULL DEFAULT NULL COMMENT '用户ID',
  `create_time` datetime NULL DEFAULT NULL COMMENT '创建时间',
  `update_time` datetime NULL DEFAULT NULL COMMENT '更新时间',
  `status` tinyint NULL DEFAULT NULL COMMENT '状态',
